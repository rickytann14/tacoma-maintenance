const ITEMS = [
  ...
  { id:'brake_fluid',   group:'fluids',  name:'Brake Fluid',                pn:'DOT 3 / SAE J1703',                           normal:25000, severe:null,   notes:'Inspect every 25K · change if discolored', inspectResets:true },
  { id:'pwr_steering',  group:'fluids',  name:'Power Steering Fluid',       pn:'DEXRON II or III',                            normal:50000, severe:null,   notes:'Inspect for leaks and fluid clarity',      inspectResets:true },
  { id:'cabin_filter',  group:'filters', name:'Cabin Air Filter',           pn:'PN# 87139-YZZ09',                             normal:20000, severe:null,   notes:'More frequently in dusty environments',    inspectResets:true },
  { id:'air_filter',    group:'filters', name:'Engine Air Filter',          pn:'PN# 17801-0P100',                             normal:5000,  severe:5000,   notes:'Inspect every 5K · change when dirty',    inspectResets:true },
  ...
  { id:'tire_rot',      group:'brakes',  name:'Tire Rotation',              pn:'Inspect for damage · Lug nuts: 83 ft·lb',     normal:5000,  severe:null,   notes:'Front-to-rear or rearward cross pattern recommended', inspectResets:true },
  { id:'front_brakes',  group:'brakes',  name:'Front Brakes',               pn:'Pads PN# 04465-AZ200 · Rotors PN# 43512-04052',normal:10000,severe:null,  notes:'Inspect every 10K · replace before 2mm thick',        inspectResets:true },
  { id:'rear_drums',    group:'brakes',  name:'Rear Drum Brakes',           pn:'PN# 04495-04010',                             normal:20000, severe:null,   notes:'Inspect every 20K · replace before 2mm thick',        inspectResets:true },
  { id:'serp_belt',     group:'brakes',  name:'Serpentine Belt',            pn:'PN# 90916-A2037',                             normal:100000,severe:null,   notes:'Replace at 100K or if chirping / cracking detected',  inspectResets:true },
];
